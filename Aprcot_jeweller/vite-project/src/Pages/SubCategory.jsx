...
const SubCategory = () => {
    ...
    return (
        <div>
                        ...
                        <div className=" w-full flex gap-[20px]">
                            ...
                            <div className="py-[208px] w-[50%] max-2xl:w-[60%] relative z-10 max-lg:w-[90%] max-lg:py-[50px]  max-md:w-[100%]">
                                ...
                                <p className="font-normal text-[17px] leading-[190%] tracking-[0%] text-[#58637C] max-sm:text-[15px]">
                                    Discover our stunning <strong>Designer Bracelet Collection</strong>, featuring handcrafted gold, silver, and diamond bracelets. From elegant statement pieces to minimalist everyday wear, each bracelet is designed with precision, luxury, and comfort in mind. Perfect for weddings, anniversaries, parties, or gifting, our collection blends modern fashion with timeless elegance—jewelry that complements every style and occasion.
                                </p>
            ...
            <section className="justify-center overflow-hidden">
                {/* <FilterdData /> */}
