...
import { useGetCategoriesQuery, useAddCategoryMutation, useEditCategoryMutation, useDeleteCategoryMutation, useGetProfileQuery } from "../services/apiSlice";
...
const Category = () => {
    ...
    const handleAddCategory = async () => {
        try {
            ...
            // ✅ Convert image path (string) to blob
    ...
    const [itemsPerPage, setItemsPerPage] = useState(10);
     const [currentPage, setCurrentPage] = useState(() => {
           return parseInt(sessionStorage.getItem("category_page") || "1");
         });
                    ...
                    <div className="flex justify-between gap-[10px] mb-[27px] flex-wrap items-center max-sm:block" >
                        ...
                        <nav className="text-sm text-gray-600 max-sm:mt-[15px] max-sm:ps-[5px]" aria-label="Breadcrumb" >
                            <ol className="flex flex-wrap items-center ">
                                ...
                                <li className="text-primary font-medium text-[12px]">All Category</li>
                            </ol>
                        </nav>
                            ...
                            <table className="w-full ">
                                <thead className=" ">
                                    <tr className="table-flex items-center h-[40px] sm:h-[54px]  ">
                                        ...
                                        <th className="text-[14px] font-[700] text-center max-md:hidden max-md:text-[12px] max-sm:px-[5px]">Type</th>
                                ...
                                <tbody className="last_tr">
                                    {displayedData?.length > 0 ? (
                                        displayedData.map((category, index) => (
                                            <tr
                                                key={index}
                                                className={`h-[44px] sm:h-[58px] transition-all duration-200 ${index % 2 === 0 ? 'bg-[#eef3f9cc] hover:bg-[rgba(35,119,252,.1)]' : 'bg-transparent hover:bg-[#eef3f9cc]'}`} onClick={(e) => {
                                                    e.stopPropagation();
                                                    sessionStorage.setItem("category_page",currentPage)
                                            ...
                                            >
                                                ...
                                                <td className="flex items-center gap-6 max-xl:min-w-[200px] max-lg:gap-4 max-md:gap-2 max-lg:min-w-[150px]" >
                                                    <div className="text-sm text-[#5E5873] cursor-pointer group-hover:bg-gray-200 ps-[30px] max-lg:px-0 max-lg:ps-[10px] max-md:ps-[5px]">
                                                        <img
                                                            src={`${import.meta.env.VITE_API_BASE_URL}${category?.category_img}`}
                                                            className="w-[60px] h-[60px] max-sm:w-[50px] max-sm:h-[50px] rounded-xl object-cover cursor-pointer my-3"
                                                            alt="product"
                                                            onClick={() =>
                                                                handleImageClick(`${import.meta.env.VITE_API_BASE_URL}${category?.category_img}`)
                                                            }
                                                        />

                                                    </div>
                                                    <h6
                                                        className="text-sm text-[#5E5873] max-md:text-[12px] truncate  max-md:max-w-[100px] max-sm:text-[11px]"
                                                        title={category?.name}
                                                    >
                                                ...
                                                <td className="text-sm text-[#5E5873] text-center px-[30px] max-md:hidden">{category?.category_type}</td>
                                                    ...
                                                    =
                                                        ...
                                                        <ul className={`absolute top-[-10px] right-2 shadow-lg bg-white rounded-[6px] p-[5px] border border-[#EBE9F1] mt-2 z-[10]  ${openDropdown === index ? 'block' : 'hidden'}`}>
                                                            <li onClick={(e) => {
                                                                ...
                                                                openModal('modal2')
                                                                edit_category11(category?.category_id)
                                                            }}
                                                            >
                                                                <button
                                                            ...
                                                            <li>
                                                                <button className="flex items-center justify-between w-[112px] p-[5px] text-sm bg-white transition-all hover:bg-[#FFD6D6] rounded-[4px]" onClick={() => {
                                                                    openModal('modal3')
                                                                    setDeletcategory(category?.category_id);
                                                                }}>
                            ...
                            <div className="relative transform overflow-hidden   p-[30px] rounded-[30px] bg-white text-left shadow-xl transition-all sm:my-8  w-full sm:max-w-2xl">
                                <div className="bg-white ">
                                    ...
                                    <form action="" className="mt-[30px] ">
                                        ...
                                        <div>
                                            <label className="block text-sm  text-gray font-medium">Category Name&nbsp;<span className="text-[#F44336] ">*</span></label>
                                            <input type="text"
                                        ...
                                        <div className='my-[15px]'>
                                            <Dropdown
                                                ...
                                                defaultValue="Home"
                                                onSelect={(value) => setCategory({ ...category, category_type: value })}
                                            />
                                        </div>
                                ...
                                <div className=" pt-[30px] flex flex-row-reverse  gap-3">
                                    <button type="button" onClick={handleAddCategory} className="inline-flex  items-center justify-center h-[35px] sm:h-[40px]  shadow-[0px_8px_20px_1px_#3DB0F733] rounded-md bg-primary    w-[154px] py-2 text-sm font-semibold text-white shadow-xs  sm:ml-3 ">Add Category</button>
                    ...
                    <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                            <div className="relative transform overflow-hidden   p-[30px] rounded-[30px] bg-white text-left shadow-xl transition-all sm:my-8  w-full sm:max-w-2xl">
                                            ...
                                            <div className="mt-[10px] w-full flex flex-col items-center">
                                                ...
                                                <div className="relative w-full flex items-center h-[35px] sm:h-[40px] px-[12px] sm:px-[15px] border border-[#C8C8C8] text-[#9CA3AF] rounded-[7px] bg-transparent text-sm cursor-pointer">
                                                    ...
                                                    {selectedImage ? (
                                                        ...
                                                        (category.category_img ? category.category_img : 'Choose File')
                                                    )}
                                                </div>
                                ...
                                <div className=" pt-[30px] flex flex-row-reverse  gap-3">
                                    <button type="button" onClick={handleEditCategory} className="inline-flex  items-center justify-center h-[35px] sm:h-[40px]  shadow-[0px_8px_20px_1px_#3DB0F733] rounded-md bg-primary    w-[154px] py-2 text-sm font-semibold text-white shadow-xs  sm:ml-3 ">Edit Category</button>
                                    <button type="button" onClick={() => closeModal()} className=" text-primary items-center closeModal h-[35px] sm:h-[40px]  inline-flex  justify-center rounded-md bg-white    py-2 w-[114px] text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-blue-600
...

            {
                modal === 'modal3' && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                        ...
                        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                            <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                                <div className="relative transform overflow-hidden p-[30px] max-md:p-[20px]  border-t-[8px] border-[#F44336] rounded-[6px] bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl z-40">
                                    <div className="bg-white ">
                                        <div className="flex items-center justify-between">
