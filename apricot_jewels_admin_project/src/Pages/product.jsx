...
import { useGetCategoriesQuery, useGetProductQuery, useDeleteProductMutation } from "../services/apiSlice";
...
const daily_logs = () => {
    ...
    const { data: product, error, isLoading } = useGetProductQuery({ page: currentPage, page_size: itemsPerPage, search_query: searchTerm });
    ...
    const handleDeleteCategory = async () => {
        try {
            ...
            formdata.append('product_id', deletcategory)

            await deleteProduct(formdata).unwrap();
    ...
    const totalPages = product?.total_pages
            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    ...
                    <div className="flex justify-between gap-[10px] mb-[27px] flex-wrap items-center max-sm:block"  >
                        <h3 className="text-[24px] font-[700]"> Product</h3>
                    ...
                    <div>
                        <div className="border mt-[30px] bg-white border-[#EBE9F1] shadow-[0px_4px_24px_0px_#0000000F]  rounded-[10px]">
                                ...
                                <table className="w-full    ">
                                    <thead className="">
                                        <tr className="table-flex items-center h-[40px] sm:h-[54px]  ">
                                            ...
                                            <th className="text-[14px] font-[700] text-center max-md:hidden max-md:text-[12px] max-sm:px-[5px]">Product ID</th>
                                            <th className="text-[14px] font-[700] text-center max-md:px-[10px] max-md:text-[13px] max-sm:px-[5px]">Quantity</th>
                                            ...
                                            displayedData.map((product, index) => (
                                                <tr
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        sessionStorage.setItem("product_page", currentPage)
                                                ...
                                                >
                                                    <td className="flex items-center gap-6 max-xl:min-w-[200px] max-lg:gap-4 max-md:gap-2 max-lg:min-w-[150px]" >
                                                        <div className="text-sm text-[#5E5873] cursor-pointer group-hover:bg-gray-200 ps-[30px] max-lg:px-0 max-lg:ps-[10px] max-md:ps-[5px]"><img
                                                            src={`${import.meta.env.VITE_API_BASE_URL}/${product?.product_img}`}
                                                            className="w-[60px] h-[60px] max-sm:w-[50px] max-sm:h-[50px] rounded-xl object-cover cursor-pointer my-3"
                                                            alt="product"
                                                            onClick={() =>
                                                                handleImageClick(`${import.meta.env.VITE_API_BASE_URL}/${product?.product_img}`)
                                                            }
                                                        />
                                                        </div>
                                                    ...
                                                    <td className="text-sm text-[#5E5873] cursor-pointer group-hover:bg-gray-200  text-center  max-md:hidden max-sm:text-[11px]">#{product?.product_id}</td>
                                                    <td className="text-sm text-[#5E5873] cursor-pointer group-hover:bg-gray-200  text-center max-sm:text-[11px]">1</td>




                                                    <td className="text-sm text-[#5E5873] cursor-pointer group-hover:bg-gray-200  text-center max-sm:text-[11px]">{product?.total_price}</td>
                                                    ...
                                                    >
                                                        {/* <div className="relative  flex justify-end" >
                                                            <div className="px-2 py-2 cursor-pointer ms-auto inline-block" onClick={(e) => {
                                                                e.stopPropagation()
                                                            ...
                                                            <ul className={`absolute top-[-10px] right-2 shadow-lg bg-white rounded-[6px] p-[5px] border border-[#EBE9F1] mt-2 z-[10]  ${openDropdown === index ? 'block' : 'hidden'}`}>
                                                                ...
                                                                <li>
                                                                    <button className="flex items-center justify-between w-[112px] p-[5px] text-sm bg-white transition-all hover:bg-[#FFD6D6] rounded-[4px]" onClick={(e) => {
                                                                        e.stopPropagation()
                                                                        openModal('modal3')
                                                                        setDeletcategory(product?.product_id);
                                                                    }}>
                                                        ...
                                                        <div className="flex gap-2 max-lg:gap-0 justify-center">
                                                            {/* <button
                                                                className="p-2 hover:bg-[rgba(35,119,252,0.1)] rounded-full transition-all  max-lg:hidden duration-200"
                                                                onClick={() => {
                                                                    localStorage.setItem('product_id', product.product_id);
                                                                    navigate('/product_details');
                                                                }}
                                                            ...
                                                            <button
                                                                className="p-2 hover:bg-[rgba(34,197,94,0.1)] rounded-full transition-all  max-lg:hidden duration-200"
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    localStorage.setItem('product_id', product.product_id);
                                                                    sessionStorage.setItem("product_page", currentPage)
                            ...
                            {product?.total_items > itemsPerPage && (
                                <div className="flex align-items-center max-sm:mx-[10px] my-[20px] justify-end mx-[30px]">
