...
import { useGetCategoriesQuery, useAddCategoryMutation, useEditCategoryMutation, useDeleteCategoryMutation, useGetProfileQuery, useGetAppoinmentQuery, useGetContactQuery } from "../services/apiSlice";
...
const Category = () => {
    ...
    const { data: categories, error, isLoading } = useGetContactQuery();
        ...
        <div>
            ...
            <div className='flex inter'>
                ...
                <div className="w-full width__right relative max-md:ms-0">
                    <SubHeader setIsOpenside={setIsOpenside} pageName={"Contact"} />
                    <div className="flex justify-between gap-[10px] mb-[27px] flex-wrap items-center max-sm:block" >
                        <h3 className="text-[24px] font-[700] "> Contact</h3>
                        ...
                        <nav className="text-sm text-gray-600 max-sm:mt-[15px] max-sm:ps-[5px]" aria-label="Breadcrumb" >
                            <ol className="flex flex-wrap items-center ">
                                ...
                                <li className="text-primary font-medium text-[12px]">All Contact</li>
                            </ol>
                        </nav>
                            ...
                            <table className="w-full ">
                                <thead className=" ">
                                    <tr className="table-flex items-center h-[40px] sm:h-[54px]  ">
                                        ...
                                        <th className="text-start px-[30px] text-[14px] font-[700]   max-md:px-[20px] max-md:text-[13px] ">First Name</th>
                                        <th className="text-[14px] font-[700] text-center max-sm:hidden max-md:text-[12px] max-sm:px-[5px]">Last Name</th>
                                        <th className="text-[14px] font-[700] text-center ">Email</th>
                                        <th className="text-[14px] font-[700] text-center max-md:px-[1px] max-md:text-[13px] max-sm:px-[5px] max-md:hidden">Mobile No. </th>
                                        <th className="text-[14px] font-[700] text-center max-md:px-[1px] max-md:text-[13px] max-sm:px-[5px] max-xl:hidden">Message </th>
                                    </tr>
                                </thead>
                                    ...
                                    {displayedData?.length > 0 ? (
                                        displayedData.map((category, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="text-sm text-[#5E5873] text-center max-sm:hidden px-[30px]">{category?.last_name?.charAt(0).toUpperCase() + category?.last_name?.slice(1)}</td>
                                                <td className="text-sm text-[#5E5873] text-center ">
                                                    {category?.email}
                                                </td>
                                                <td className="text-sm text-[#5E5873] text-center max-md:hidden">
                                                    {category?.mobile}
                                                </td>

                                                <td className="text-sm text-[#5E5873] max-xl:hidden  text-center whitespace-nowrap">
                                                    {category?.message?.split(" ").slice(0, 15).join(" ") + (category?.message?.split(" ").length > 15 ? "..." : "")}
                            ...
                            <div className="relative transform overflow-hidden   p-[30px] rounded-[30px] bg-white text-left shadow-xl transition-all sm:my-8  w-full sm:max-w-2xl">
                                <div className="bg-white ">
                                    <div className="flex items-center justify-between">
                                        <h3 className="text-xl font-medium text-gray">Contact Details</h3>
                                        <div>
